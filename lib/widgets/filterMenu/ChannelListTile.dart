  ...
  Widget build(BuildContext context) {
    return new ListTile(
        ...
        leading: new CircleAvatar(
          ...
          child: new Image(image: new AssetImage("assets/img/"+ channel.avatarImage)),
        ),
        title: new Row(
          ...
          children: <Widget>[
            ...
            new Checkbox(value: channel.isCheck,activeColor: Colors.grey[700], onChanged: (bool value) {
              setState(() {
