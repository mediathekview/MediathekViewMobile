...
//  final IconButton filterButton;
  ...
  GradientAppBar(this.controller, this.filterMenu);
          ...
          new Padding(
            ...
            child: new Row(
              ...
              children: [
                ...
                new Theme(
                  data: theme.copyWith(primaryColor: new Color(0xffffbf00), brightness: Brightness.dark, accentColor: new Color(0xffffbf00)),
                  child: new Expanded(
                    child: new Container(padding: new EdgeInsets.only(right: 20.0), child: new TextField(
                      style: inputTextStyle,
                      controller: controller,
                      decoration: new InputDecoration(
                        suffixIcon:  new IconButton(color: controller.text.isNotEmpty? Colors.red: Colors.transparent, onPressed: () {controller.text = "";},icon: new Icon(Icons.clear, size: 30.0, )),
                        labelStyle: hintTextStyle.copyWith(color: theme.indicatorColor),
...
//                        hintText: 'Suche',
          ...
          isFilterMenuOpen
              ? new Padding(
                  padding: new EdgeInsets.only(bottom: 10.0, top: 10.0), child: filterMenu)
              : new Container(),
        ],
      ),
    );
